    ...
    LinkedHashMap paginateList(GrailsParameterMap params) {
        ...
        if (totalCount > 0) {
            ...
            results.each { SalDps salDps ->
                ...
                totalBalance = salDps.totalInsAmount + salDps.totalOwnAmount
                dataReturns.add([DT_RowId: salDps.id, 0: serial, 1: salDps.employee.empID, 2: salDps.employee.name,3: salDps.employee.hrDesignation.name, 4:salDps.totalInsAmount,5: salDps.totalOwnAmount,6: totalBalance , 7:'' ])
            }
        }
