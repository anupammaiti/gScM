<%@ page import="com.grailslab.enums.YearMonths; com.grailslab.enums.SelectionTypes" %>
<!DOCTYPE html>
                ...
                $('#grade5Chart').highcharts({
                    ...
                    series: [{
                        ...
                        data: [{
                            ...
                            name: 'Approval <br/> Before <br/> Leave ',
                            color: 'green',
                            y: 70.33


                        }, {
                            name: 'Approval <br/> After <br/> Leave',
                            color: 'orange',
                            y: 29.67
                        },{
                            name: 'Without <br/> Approval',
                            color: 'DarkRed  ',
                            y: 29.67
