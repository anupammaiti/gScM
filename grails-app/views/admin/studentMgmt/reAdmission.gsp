...
<body>
<grailslab:breadCrumbActions breadCrumbTitleText="Re Admission" />
    ...
    jQuery(function ($) {
        $('#load-old-btn').click(function (e) {
            ...
            jQuery.ajax({
                type: 'POST',
                dataType:'JSON',
                url: "${g.createLink(controller: 'student',action: 'loadReadmission')}?academicYear="+academicYear+"&className="+className,
