...
<body>
<grailslab:breadCrumbActions firstBreadCrumbUrl="${g.createLink(controller: 'classRoutine', action: 'classRoutine')}" firstBreadCrumbText="Class Routine" breadCrumbTitleText="Add/Edit Class Routine"/>
<div class="row" >
    <div class="col-sm-12">
        <section class="panel">
...
<script>
    var classRoutineTable,academicYear, className, subject, remoteUrl, section;
    jQuery(function ($) {
        ...
        classRoutineTable = $('#list-table').DataTable({
            ...
            "fnServerParams": function (aoData) {
                aoData.push({"name": "routineType", "value": "classRoutine"});
        ...
        $('#create-form #className').change(function () {
            classRoutineTable.draw(false);
        });
        $('#create-form #section').change(function () {
            classRoutineTable.draw(false);
        });
