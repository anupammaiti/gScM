...
<html>
<head>
    <title>Certification Entry</title>
    <meta name="layout" content="moduleHRLayout"/>
</head>
<body>
<grailslab:breadCrumbActions breadCrumbTitleText="Add Certification" SHOW_CREATE_BTN="YES" createButtonText="Add New certification"/>
<grailslab:fullModal label="Certification Entry">
    ...
    jQuery(function ($) {
        var validator = $('#modalForm').validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    url: "${createLink(controller: 'hrSettings', action: 'certificationSave')}",
                    type: 'post',
                    dataType: "json",
        ...
        $('#list-table').dataTable({
            ...
            "sAjaxSource": "${g.createLink(controller: 'hrSettings',action: 'certificationList')}",
        ...
        $('#list-table').on('click', 'a.edit-reference', function (e) {
            ...
            jQuery.ajax({
                type: 'POST',
                dataType: 'JSON',
                url: "${g.createLink(controller: 'hrSettings',action: 'certificationEdit')}?id=" + referenceId,
        ...
        $('#list-table').on('click', 'a.delete-reference', function (e) {
            ...
            if (confirmDel == true) {
                ...
                jQuery.ajax({
                    type: 'POST',
                    dataType: 'JSON',
                    url: "${g.createLink(controller: 'hrSettings',action: 'certificationDelete')}?id=" + referenceId,
                    success: function (data, textStatus) {
                        if (data.isError == false) {
        ...
        $('#list-table').on('click', 'a.inactive-reference', function (e) {
            ...
            if (confirmDel == true) {
                ...
                jQuery.ajax({
                    type: 'POST',
                    dataType: 'JSON',
                    url: "${g.createLink(controller: 'hrSettings',action: 'certificationInactive')}?id=" + referenceId,
                    success: function (data, textStatus) {
                        if (data.isError == false) {
