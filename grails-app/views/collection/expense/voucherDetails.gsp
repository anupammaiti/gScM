        ...
        <section class="panel">
            <div class="panel-body create-content">
                <form class="form-horizontal" role="form" id="expenseForm">
                    <input type="hidden" name="id" id="cashUpdate">
...
<div class="modal fade" data-keyboard="false" id="voucherModal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-mid">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span
                        class="sr-only">Close</span></button>
                <h4 class="modal-title" id="cashLabelVoucher">Voucher List</h4>
            </div>
        </div>
        <section class="panel">
            <div class="panel-body create-content">
                <form class="form-horizontal" role="form" id="voucherModalForm">
                    <input type="hidden" name="id" id="voucherUpdate">

                    <div class="modal-body">

                        <div class="table-responsive">
                            <table class="table table-striped table-hover table-bordered" id="voucherModalTable">
                                <thead>
                                <tr>
                                    <th>Invoice Id</th>
                                    <th>Voucher Id</th>
...
<div class="modal fade" data-keyboard="false" id="voucherDetailsModal" tabindex="-1"
     role="dialog"
     aria-labelledby="voucherModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-mid">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span
                        class="sr-only">Close</span></button>
                <h4 class="modal-title" id="labelvoucherDetails">Voucher Details</h4>
            </div>
        </div>
        <section class="panel">
            <div class="panel-body create-content">
                <form class="form-horizontal" role="form" id="voucherDetailsForm">
                    <input type="hidden" name="id" id="voucherDetailsUpdate">

                    <div class="modal-body">

                        <div class="table-responsive">
                            <table class="table table-striped table-hover table-bordered" id="voucherDetailsModalTable">
                                <thead>
                                <tr>
                                    <th>Account Item</th>
                                    <th>Quantity</th>
    ...
    jQuery(function ($) {
        ...
        $('#buttonAdd').on('click', function () {
            ...
            if (!(expenseVal == '' || quantity == '' || quantity == 0 || unitPrice == '' || unitPrice == 0 || amount == '' || amount == 0)) {
                table.row.add([
                    expenseText + '<input type="hidden" class="expenseInput" name="expense" value="' + expenseVal + '">',
