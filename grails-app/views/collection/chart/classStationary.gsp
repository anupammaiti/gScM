...
<head>
    ...
    <title>Class Sttionary</title>
</head>
<body>
<grailslab:breadCrumbActions breadCrumbTitleText="Manage Class Stationary" SHOW_CREATE_BTN="YES"/>
<div class="row">
    <div class="col-sm-12">
        <section class="panel">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="form-horizontal" role="form" id="createFormModal">
                ...
                <g:hiddenField name="feeAppliedType" value="${FeeAppliedType.CLASS_STD.key}"/>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group">
                            <label for="className" class="col-md-4 control-label">Select Class *</label>
                ...
                <div class="modal-footer">
                    <button class="btn  btn-default" id="cancelButton" data-dismiss="modal" aria-hidden="true">Cancel</button>
    ...
    jQuery(function ($) {
        ...
        $('#list-table').dataTable({
            ...
            "fnServerParams": function (aoData) {
                aoData.push({ "name": "className", "value": $('#className-filter').val()}, { "name": "feeAppliedType", "value": "${FeeAppliedType.CLASS_STD.key}" });
            },
