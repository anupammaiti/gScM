...
<html>
<head>
    <title>Gallery Picture Album</title>
    <meta name="layout" content="moduleWebLayout"/>
</head>
<body>
<grailslab:breadCrumbActions breadCrumbTitleText="Picture Gallery Album" SHOW_CREATE_BTN="YES" createButtonText="Add New Album"/>
<grailslab:fullModal modalLabel="Manage Picture Album">
...
<grailslab:dataTable dataSet="${dataReturn}" tableHead="SL, Album Name, Sort Position, Status, Description" actions="fa fa-plus-square-o, fa fa-pencil-square-o,fa fa-retweet"></grailslab:dataTable>
...
<script>
    jQuery(function ($) {
        var validator = $('#modalForm').validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    ...
                    url: "${createLink(controller: 'gallery', action: 'saveGallery')}?galleryType=${com.grailslab.enums.OpenContentType.PICTURE.key}",
        ...
        $('#list-table').dataTable({
            ...
            "sAjaxSource": "${g.createLink(controller: 'gallery',action: 'albumList')}?albumType=${com.grailslab.enums.OpenContentType.PICTURE.key}",
        ...
        $('#list-table').on('click', 'a.reference-1', function (e) {
            ...
            var url = "${g.createLink(controller: 'gallery',action: 'pictureItem')}?album=" + referenceId;
            window.open(url);
            e.preventDefault();
