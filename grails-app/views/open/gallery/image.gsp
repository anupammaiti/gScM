...
<section class="pageheader-default text-center">
    <div class="semitransparentbg">
        <h1 class="animated fadeInLeftBig notransition">Picture Gallery..</h1>
    </div>
</section>
                        ...
                        <div class="col-md-3">
                            <div class="pic">
                                <div class="mix class-room">
                                    <a href="${g.createLink(controller: 'home', action: 'imageSlide', params: [album:dataSet.DT_RowId])}">
                                        <img src="${imgSrc.fromIdentifier(imagePath: dataSet.imagePath)}" alt="Image"
